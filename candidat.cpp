...
QSqlQueryModel *Candidat::afficherCand()
{
    QSqlQueryModel *modelCand = new QSqlQueryModel();
    modelCand->setQuery("SELECT CODE_CANDIDAT, NOM_CANDIDAT, PRENOM_CANDIDAT, CIN_CANDIDAT, ADRESSE_CANDIDAT, NUMTEL_CANDIDAT, NIVEAU_CANDIDAT FROM CANDIDAT");
    return modelCand;
}

bool Candidat::supprimerCand(QString code)
{
    QSqlQuery query;
...
bool Candidat::modifierCand(QString code, QString prenom, int cin, QString adresse, QString nom, int numTel, QString niveau, QByteArray photo)
{
    QSqlQuery query;
