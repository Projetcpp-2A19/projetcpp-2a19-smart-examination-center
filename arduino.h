...
public:     //méthodes de la classe Arduino
    ...
    void sendToArduino(const QByteArray &data);
private:
    ...
    static const quint16 arduino_uno_vendor_id = 0x1A86; // VID de l'appareil
    static const quint16 arduino_uno_producy_id = 0x7523; // PID de l'appareil
