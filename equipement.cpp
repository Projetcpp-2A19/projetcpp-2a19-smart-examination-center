...
QSqlQueryModel* Equipement::afficherEquip() {
    QSqlQueryModel *modelEqui = new QSqlQueryModel();
    modelEqui->setQuery("SELECT ID_EQUIPEMENT, NOM_EQUIPEMENT, TYPE_EQUIPEMENT, STATUT_EQUIPEMENT, QUANTITE__EQUIPEMENT FROM EQUIPEMENTS ORDER BY ID_EQUIPEMENT ASC");
    return modelEqui;
}
...
bool Equipement::supprimerEquip(int id) {
    QSqlQuery query;
...
bool Equipement::modifierEquip(int equipmentId, const QString &nom, const QString &type, const QString &statut, int quantite)
{
    QSqlQuery query;
...
{
    QSqlQueryModel *modelEqui = new QSqlQueryModel();
    modelEqui->setQuery("SELECT ID_EQUIPEMENT, NOM_EQUIPEMENT, TYPE_EQUIPEMENT, STATUT_EQUIPEMENT, QUANTITE__EQUIPEMENT FROM EQUIPEMENTS ORDER BY NOM_EQUIPEMENT ASC");
    return modelEqui;
}
