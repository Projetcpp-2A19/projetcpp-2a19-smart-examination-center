...
QSqlQueryModel* Etablissement::afficherEta() {
    QSqlQueryModel *model_Eta = new QSqlQueryModel();
    model_Eta->setQuery("SELECT ID_ETABLISSEMENT, GOUVERNORAT_ETABLISSEMENT, TYPE_ETABLISSEMENT, "
                    "DIRECTEUR_ETABLISSEMENT, NOM_ETABLISSEMENT, NOMBRESALLE_ETABLISSEMENT, "
                    "VILLE_ETABLISSEMENT, ADRESSE_ETABLISSEMENT, IMAGE_PATH, ID_SUPERVISEUR, ID_EQUIPEMENT "
                    "FROM ETABLISSEMENT");
    ...
    model_Eta->setHeaderData(7, Qt::Horizontal, QObject::tr("Adresse"));
    model_Eta->setHeaderData(8, Qt::Horizontal, QObject::tr("Image"));
    model_Eta->setHeaderData(9, Qt::Horizontal, QObject::tr("ID Superviseur"));
    model_Eta->setHeaderData(10, Qt::Horizontal, QObject::tr("ID Equipement"));

    return model_Eta;
}

// Supprimer un établissement
bool Etablissement::supprimerEta(QString id) {
    QSqlQuery query;
...
bool Etablissement::modifierEta() {
    QSqlQuery query;
